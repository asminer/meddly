...
./configure CXXFLAGS="-O3" LDFLAGS=-L/$GMP/lib CPPFLAGS=-I/$GMP/include

echo
echo Configured using $GMP for gmp, with development tests off,
echo compiler optimizations on
echo
