...
int main(int argc, char *argv[])
{
  ...
  int_extra state1[nLevels+1] = {0, 0, DONT_CARE, 0};
  ...
  int_extra from1[nLevels+1] = {0, 0, DONT_CARE, DONT_CARE};
  int_extra from2[nLevels+1] = {0, DONT_CARE, DONT_CARE, 0};
  int_extra to1[nLevels+1] = {0, 1, 1, DONT_CHANGE};
  int_extra to2[nLevels+1] = {0, DONT_CHANGE, DONT_CHANGE, DONT_CARE};
