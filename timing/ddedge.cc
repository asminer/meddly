...
{
    std::cerr << "Creating array of " << EDGES << " edges\n";
    ...
    std::cerr << "Updating array " << CHANGES*16 << " times ";
    ...
    std::cerr << ' ';
    show_sec(std::cerr, T, 3, 3);
    std::cerr << "\n\n";
    std::cerr << "Max edges in forest 1: " << f1max << "\n";
    std::cerr << "Max edges in forest 2: " << f2max << "\n\n";

    std::cerr << "Current null edges: " << nocurr << "\n";
    std::cerr << "Current  F1  edges: " << f1curr << "\n";
    std::cerr << "Current  F2  edges: " << f2curr << "\n";
    std::cerr << "                    " << nocurr + f1curr + f2curr << "\n";
}
