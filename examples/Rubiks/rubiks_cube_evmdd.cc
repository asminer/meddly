...
int main(int argc, char *argv[])
{
  ...
  states = CreateForest(d, EVMDD, false, reduction_rule::QUASI_REDUCED, FULL_OR_SPARSE_STORAGE);
  ...
  // relation = CreateForest(d, MXD, false, reduction_rule::QUASI_REDUCED, FULL_OR_SPARSE_STORAGE);
#else
  states = CreateForest(d, EVMDD, false, reduction_rule::FULLY_REDUCED, FULL_STORAGE);
