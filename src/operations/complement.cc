...
{
    _setup("COMPLEMENT", "Complement, for functions with boolean range. Inverts the output (false becomes true, true becomes false). The input and output forests may be different, but the must have the same domain.");
}
