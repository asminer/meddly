...
void MEDDLY::mt_mdd_int::createEdge(const int_extra* const* vlist, const long* terms, int N, dd_edge &e)
{
...
void MEDDLY::mt_mdd_int
::evaluate(const dd_edge &f, const int_extra* vlist, long &term) const
{
