...
void MEDDLY::mt_mdd_int::createEdge(const general_int* const* vlist, const long* terms, int N, dd_edge &e)
{
...
void MEDDLY::mt_mdd_int
::evaluate(const dd_edge &f, const general_int* vlist, long &term) const
{
