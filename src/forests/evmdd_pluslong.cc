...
MEDDLY::evmdd_pluslong
 ::evmdd_pluslong(int dsl, domain *d, const policies &p, bool index_set)
...
MEDDLY::evmdd_index_set_long::evmdd_index_set_long(int dsl, domain *d, const policies &p)
 : evmdd_pluslong(dsl, d, p, true)
{ }
