...
::createEdge(const int_extra* const* vlist, const int_extra* const* vplist, int N, dd_edge &e)
{
...
void MEDDLY::mt_mxd_bool::evaluate(const dd_edge &f, const int_extra* vlist,
