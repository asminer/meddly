...
inline long
MEDDLY::gen_relation_node::getPieceSize() const
{
  return piece_size;
}

inline void
MEDDLY::gen_relation_node::setPieceSize(long pS)
{
  piece_size=pS;
}

inline long*
MEDDLY::gen_relation_node::getTokenUpdate() const
{
  return token_update;
}
...
inline
void
MEDDLY::gen_relation_node::setTokenUpdate(long* n_token_update)
{
  token_update = n_token_update;
}
