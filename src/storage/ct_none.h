...
template <bool MONOLITHIC, bool CHAINED>
inline int* MEDDLY::ct_none<MONOLITHIC, CHAINED>
...
template <bool MONOLITHIC, bool CHAINED>
int MEDDLY::ct_none<MONOLITHIC, CHAINED>::convertToList(bool removeStales)
{
  MEDDLY_DCASSERT(CHAINED);
...
template <bool MONOLITHIC, bool CHAINED>
void MEDDLY::ct_none<MONOLITHIC, CHAINED>::listToTable(int L)
{
...
template <bool MONOLITHIC, bool CHAINED>
void MEDDLY::ct_none<MONOLITHIC, CHAINED>::rehashTable(const int* oldT, unsigned oldS)
{
#ifdef DEBUG_REHASH
